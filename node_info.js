38877,330.15700000000004,436,326.466,436,320.563L436,98.70931C436,92.79851,442.38203,89.09225,447.5076,92.02648L640.763,202.659C645.909,205.60500000000002,645.909,213.029,640.763,215.99L447.5076,327.211ZM1264.492,92.78931C1269.6109999999999,89.84338,1276,93.5341,1276,99.43713L1276,321.291C1276,327.201,1269.618,330.908,1264.492,327.974L1071.237,217.341C1066.091,214.39499999999998,1066.091,206.971,1071.237,204.01L1264.492,92.78931Z" fill="#666666" fill-opacity="1"/></g></g></svg>`
...
const ButtonManager = {
    ...
    init() {
        ...
        this.buttonContainer.id = 'dj-align-buttons';
        ...
        wrapper.id = 'dj-align-buttons-wrapper';
        ...
        style.textContent = `
            ...
            .custom-button:hover svg {
                filter: brightness(0) saturate(100%) invert(85%) sepia(35%) saturate(400%) hue-rotate(5deg) brightness(95%);
            }
            .divider {
                width: 4.8px;
                height: 22.5px;
        ...
        // Create context menu (info only)
        const contextMenu = document.createElement('div');
        contextMenu.id = 'context-menu';
        contextMenu.innerHTML = `
            <button id="menu-info">本功能隶属 ComfyUI-DJ_align 节点</button>
        `;
        ...
        // Default to on-select mode: hidden until nodes are selected
    ...
    getButtons() {
        return [
            ...
            { id: 'equalMinWidth', svg: equalWidth2Svg, action: this.equalMinWidth.bind(this) },
            /* 等高 */
            { id: 'equalHeight', svg: equalHeightSvg, action: this.equalHeight.bind(this) },
            { id: 'equalMinHeight', svg: equalHeight2Svg, action: this.equalMinHeight.bind(this) },
        ];
    },
    ...
    onDragEnd() {
        ...
        // 保存位置到 localStorage
        localStorage.setItem('DJAlignButtonContainerPosition', JSON.stringify({ top, left, right, bottom }));
    },
    destroy() {
    ...
    restorePosition() {
        try {
            const savedPosition = JSON.parse(localStorage.getItem('DJAlignButtonContainerPosition'));
            if (savedPosition && typeof savedPosition === 'object') {
                this.buttonContainer.style.top = savedPosition.top || '30px';
                this.buttonContainer.style.bottom = savedPosition.bottom || 'unset';
                this.buttonContainer.style.left = savedPosition.left || 'unset';
                this.buttonContainer.style.right = savedPosition.right || '30px';
            } else {
        ...
        if (
            ...
            console.log('DJAlign位置已超出屏幕范围，重置为默认位置');
            // 调用setDefaultPosition重置位置
            this.setDefaultPosition();

            // 保存默认位置到 localStorage，确保下次进入不会越界
            localStorage.setItem('DJAlignButtonContainerPosition', JSON.stringify({
    ...
    setDefaultPosition() {
        this.buttonContainer.style.top = '30px';
        this.buttonContainer.style.right = '30px';
        this.buttonContainer.style.bottom = 'unset';
    ...
    equalMinHeight() {
        this.equalSize(1, Math.min);
    },


    // 通用的节点尺寸调整
    equalSize(axis, comparator = Math.max) {
        const nodes = this.getSelectedNodes();
        if (nodes.length > 0) {
            // 使用传入的比较函数（默认为 Math.max）
            const sizeValues = nodes.map(node => node.size[axis]);
            const targetSize = comparator(...sizeValues);
    
            // 将尺寸调整为最近的5的倍数
            const roundedTargetSize = Math.round(targetSize / 5) * 5;
    
            nodes.forEach(node => {
                node.size[axis] = roundedTargetSize; // 设置所有节点的大小为目标值（5的倍数）
            });
        ...
        canvas.addEventListener('click', function (event) {
            ...
            if (!ButtonManager.isPermanent) {
                ...
                if (selectedNodes.length >= 2) {
                    ButtonManager.show();
                    const panelWidth = 435;
                    const panelHeight = 48;
                    let x = event.clientX - panelWidth / 2;
                    let y = event.clientY + 20;
                    if (y + panelHeight > window.innerHeight) y = event.clientY - panelHeight - 20;
                    if (x < 0) x = 0;
                    ButtonManager.setPosition(x, y);
                } else {
                    ButtonManager.hide();
                }
            }
